...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final GuaveVersionAccessors vaccForGuaveVersionAccessors = new GuaveVersionAccessors(providers, config);
        ...
        /**
         * Returns the group of versions at versions.guave
         */
        public GuaveVersionAccessors getGuave() {
            return vaccForGuaveVersionAccessors;
        }
    ...
    public static class GuaveVersionAccessors extends VersionFactory  {

        public GuaveVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: guave.version (32.0.0-android)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in settings file 'settings.gradle.kts'
             */
            public Provider<String> getVersion() { return getVersion("guave.version"); }
    ...
    public static class KotlinVersionAccessors extends VersionFactory  {
        ...
        public KotlinVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: kotlin.version (1.9.10)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in settings file 'settings.gradle.kts'
             */
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        public PluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for versions to the plugin id 'org.jetbrains.kotlin.jvm'
