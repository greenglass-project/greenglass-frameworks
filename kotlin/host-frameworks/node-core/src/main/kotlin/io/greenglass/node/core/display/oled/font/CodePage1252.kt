...
/**
 * A simple [Font] implementation, based on the Windows-1252 character set.
 *
 * @author fauxpark
 * @see [Windows-1252](https://en.wikipedia.org/wiki/Windows-1252)
 */
class CodePage1252 : Font {
    /**
     * The name of the font's character set.
     */
    override val name = "windows-1252"
     ...
     * The font glyphs.
     */
    override val glyphs = intArrayOf(
