...
/**
 * A simple [Font] implementation, based on the MS-DOS character set.
 *
 * @author fauxpark
 * @see [Code page 850](https://en.wikipedia.org/wiki/Code_page_850)
 */
abstract class CodePage850 : Font {
    /**
     * The name of the font's character set.
     */
    override val name = "IBM850"
