...
catalog {
    ...
    versionCatalog {
        ...
        version("kotlin-coroutines-version", "1.8.0")
        ...
        version("commons-io-version","2.16.1")
        ...
        version("zeroconf-version","1.3.2")
        version("jmdns-version","3.5.9")
        version("logback-version","1.5.6")
        version("ktor-version", "2.3.11")
        ...
        library("zeroconf", "xyz.gianlu.zeroconf","zeroconf").versionRef("zeroconf-version")
        library("jmdns","org.jmdns","jmdns").versionRef("jmdns-version")
        library("logback","ch.qos.logback","logback-classic").versionRef("logback-version")
        library("ktor-client","io.ktor","ktor-client-websockets").versionRef("ktor_version")
        library("ktor-client-core","io.ktor","ktor-client-core").versionRef("ktor_version")
        library("ktor-client-cio", "io.ktor","ktor-client-cio").versionRef("ktor_version")
